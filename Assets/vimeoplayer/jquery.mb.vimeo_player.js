	...
	jQuery.vimeo_player = {
		...
		buildPlayer: function( options ) {
			...
			return this.each( function() {
				...
				var property = $vimeo_player.data( "property" ) && typeof $vimeo_player.data( "property" ) == "string" ? ( '(' + $vimeo_player.data( "property" ) + ')' ) : $vimeo_player.data( "property" );
				...
				jQuery( document ).on( "vimeo_api_loaded", function() {
					...
					vimeo_player.player.ready().then( function() {
						...
						vimeo_player.player.on( "play", function( data ) {
							...
							if( typeof _gaq != "undefined" && ( vimeo_player.opt.gaTrack ) ) _gaq.push( [ '_trackEvent', 'vimeo_player', 'Play', vimeo_player.videoID ] );
							if( typeof ga != "undefined" && ( vimeo_player.opt.gaTrack ) ) ga( 'send', 'event', 'vimeo_player', 'play', vimeo_player.videoID );
		...
		buildControls: function( vimeo_player ) {
			...
			if( vimeo_player.isBackground || ( ( vimeo_player.opt.realfullscreen ) && !vimeo_player.isBackground ) ) buttonBar.append( fullscreen );
